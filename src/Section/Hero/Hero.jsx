    ...
    return (
        <div className='bg-my-lightpink relative'>
            <div className='absolute'>
                <img src="/images/heroLeft.png" className='w-[387px] object-cover' alt="" />
            </div>
            <div className='container mx-auto flex items-center p-4 flex-1  py-20'>
                <div className=''>
                ...
                <img src="/images/hero.png" className='w-[650px] h-[550px] object-cover' alt="" />
            </div>
        </div>
    )
}
